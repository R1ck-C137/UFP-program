...
namespace Приложение_по_физре
{
    public partial class Itogi : Excel.Page
    {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            app.person.Age = (int)app.person.Age;
            //addInTable.AddInTableValue(ref GridList, "Возраст", app.Indication[0], point : Point[0]);
            addInTable.AddInTableValue(ref GridList, "Возраст", app.person.Age, point : app.person.Age);

            if (app.person.Gender == true) //if (app.Gender == true)//мужской пол
            {
                СalculationForMen();
            }
            else
        ...
        public void СalculationForMen()
        {
            ...
            //if (app.Indication[4] <= app.Indication[3] + 10) 
